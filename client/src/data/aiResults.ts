...
export const aiResults: Record<string, AIResult> = {
  chatgpt: {
    ...
    tagline: "친근한 대화형 AI",
    icon: "💬",
    description: "당신은 사교적이고 친근한 성격의 소유자입니다. 다양한 주제에 대해 자연스럽게 대화할 수 있으며, 상대방의 말을 잘 들어주는 능력이 뛰어납니다. ChatGPT처럼 당신은 도움이 되는 정보를 제공하고 상대방과 즐거운 대화를 나누는 것을 좋아합니다.",
  ...
  claude: {
    id: "claude",
    name: "Claude",
    tagline: "사려깊은 AI 어시스턴트",
    icon: "🤖",
    description: "당신은 신중하고 사려깊은 성격의 소유자입니다. 복잡한 문제를 차근차근 분석하며, 다양한 관점에서 상황을 바라보는 능력이 뛰어납니다. Claude처럼 당신은 도움이 되고 정확한 정보를 제공하는 것을 중요하게 생각하며, 상대방의 입장을 이해하려 노력합니다.",
  ...
  midjourney: {
    id: "midjourney",
    name: "Midjourney",
    tagline: "창조적인 비주얼 아티스트",
    icon: "🎨",
    description: "당신은 상상력이 풍부하고 창의적인 성격의 소유자입니다. 아름다운 것을 추구하며, 독특하고 인상적인 작품을 만들어내는 능력이 뛰어납니다. Midjourney처럼 당신은 시각적 표현을 통해 감정과 아이디어를 전달하는 것을 좋아합니다.",
  ...
  runway: {
    id: "runway",
    name: "Runway",
    tagline: "혁신적인 영상 크리에이터",
    icon: "🎬",
    description: "당신은 역동적이고 트렌드에 민감한 성격의 소유자입니다. 움직임과 변화를 좋아하며, 새로운 기술을 빠르게 습득하는 능력이 뛰어납니다. Runway처럼 당신은 혁신적인 아이디어로 사람들에게 새로운 경험을 제공하는 것을 즐깁니다.",
  ...
  notion: {
    id: "notion",
    name: "Notion AI",
    tagline: "체계적인 생산성 마스터",
    icon: "📝",
    description: "당신은 체계적이고 효율성을 중시하는 성격입니다. 복잡한 정보를 정리하고 구조화하는 능력이 뛰어나며, 생산성 향상에 관심이 많습니다. Notion AI처럼 당신은 모든 것을 체계적으로 관리하고 최적화하는 것을 좋아합니다.",
  ...
  copilot: {
    ...
    tagline: "믿음직한 코딩 파트너",
    icon: "💻",
    description: "당신은 논리적이고 체계적인 사고를 가진 성격입니다. 문제를 단계별로 해결하며, 효율적인 방법을 찾는 것을 좋아합니다. GitHub Copilot처럼 당신은 다른 사람과 협력하여 더 나은 결과를 만들어내는 훌륭한 파트너입니다.",
